...
def handle_gift_codes_button(update: Update, context: CallbackContext):
    ...
    keyboard = [
        [InlineKeyboardButton("🔗 JOIN CHANNEL 1", url="https://t.me/+xH5jHvfkXSI0Nzll"),
         InlineKeyboardButton("🔗 JOIN CHANNEL 2", url="https://t.me/+YOUR_SECOND_CHANNEL_LINK")],
    ...
    try:
        ...
        if not all_joined:
            ...
            try:
                ...
                try:
                    query.message.reply_text(not_joined_msg, parse_mode='Markdown', reply_markup=reply_markup)
                except Exception as e2:
